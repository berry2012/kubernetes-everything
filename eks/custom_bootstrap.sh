...
touch /home/data.txt
echo "IP_FAMILY: ${IP_FAMILY}" >> /home/data.txt
echo "DNS_CLUSTER_IP: ${DNS_CLUSTER_IP}" >> /home/data.txt
echo "SERVICE_IPV6_CIDR: ${SERVICE_IPV6_CIDR}" >> /home/data.txt
echo "B64_CLUSTER_CA: ${B64_CLUSTER_CA}" >> /home/data.txt
echo "APISERVER_ENDPOINT: ${APISERVER_ENDPOINT}" >> /home/data.txt
echo "DESCRIBE_CLUSTER_RESULT: ${DESCRIBE_CLUSTER_RESULT}" >> /home/data.txt
